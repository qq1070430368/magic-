...
import echartsSeror from '../../app/common/echart.seror.derective';
console.log(echartsSeror, 'asdasdasd')
class factory {
...
export default
    angular.module('fmDashboardCrop', [echartsSeror])
        .constant('cropNavTaskList', cropNavTaskList())
        .factory('dashboardCropServive', ['$http', '$q', ($http, $q) => new factory($http, $q)])
