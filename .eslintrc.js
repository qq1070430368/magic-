module.exports = {
    ...
    "globals": {
        ...
        "angular": true,        // angular.js
        "Strophe": true,        // Strophe.js
        "FastClick": true,      // FastClick.js
        "app": true,            // app项目主模块
        "agriculture": true,    // 农业模块
        "safetysupervision": true,  // 安全模块
        "echarts": true,        // baidu Echarts
        "LGeo": true,           // 计算图层面积
        "lodash": true,         // lodash 
        "d3": true
    },
    "rules": {
        ...
        // angular项目注入模块多与7个，先不做限定 chenfengtao 2018-04-09
        'max-params': 'off',
        // 限制函数块中的语句数量
        // @off 没必要限制
        'max-statements': 'off',
